...
export default function Footer() {
  ...
  return (
    ...
    <footer className="site-footer-wrapper reveal reveal-up">
      ...
      <div className="site-footer">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col reveal-base reveal-up">
          ...
          <div className="footer-col footer-middle-col reveal-base reveal-up delay-100">
          ...
          <div className="footer-col footer-right-col reveal-base reveal-up delay-200">
