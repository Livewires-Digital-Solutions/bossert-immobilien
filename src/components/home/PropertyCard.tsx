...
export default function PropertyCard({ slug, imageSrc, type, price, location, specs, className = "" }: PropertyCardProps) {
  return (
    <Link href={`/properties/${slug}`} className={`property-card reveal reveal-up ${className}`}>
