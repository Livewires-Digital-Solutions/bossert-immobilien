...
export default function SearchSection() {
  ...
  return (
    <section className="search-section">
      <div className="search-container reveal reveal-scale" ref={containerRef}>
        ...
        <div className="search-bar">
          <div className="search-filter">
            ...
            <div className="filter-input-row">
              ...
              <input type="text" placeholder={t('placeholder')} className="search-input" />
            </div>
          </div>
          <div className="search-divider"></div>
          
          <div className="search-filter clickable" onClick={() => toggleDropdown('propertyType')}>
            <div className="filter-label">{t('type')}</div>
            <div className="filter-input-row">
          ...
          <div className="search-filter clickable" onClick={() => toggleDropdown('bedrooms')}>
            <div className="filter-label">{t('bedrooms')}</div>
            <div className="filter-input-row">
          ...
          <div className="search-filter clickable" onClick={() => toggleDropdown('yearBuilt')}>
            <div className="filter-label">{t('yearBuilt')}</div>
            <div className="filter-input-row">
        ...
        <div className="advanced-search-header">
          <div className="advanced-search">
            ...
            />
            <label htmlFor="advancedSearch">{t('advancedBtn')}</label>
          </div>
        </div>
          ...
          <div className="advanced-filters-content">
            ...
            <div className="adv-grid-top">
              <div className="adv-filter-box">
                <div className="adv-label">{t('price')}</div>
                <div className="adv-input-group">
                  <input type="number" min="0" placeholder={t('filters.minPrice')} />
                  <span>{t('to')}</span>
                  <input type="number" min="0" placeholder={t('filters.maxPrice')} />
                </div>
              </div>
              <div className="adv-filter-box">
                <div className="adv-label">{t('size')}</div>
                <div className="adv-input-group">
                  <input type="number" min="0" placeholder={t('filters.minSqm')} />
                  <span>{t('to')}</span>
                  <input type="number" min="0" placeholder={t('filters.maxSqm')} />
                </div>
              </div>
              <div className="adv-filter-box">
                <div className="adv-label">{t('landArea')}</div>
                <div className="adv-input-group">
                  <input type="number" min="0" placeholder={t('filters.minSqm')} />
                  <span>{t('to')}</span>
                  <input type="number" min="0" placeholder={t('filters.maxSqm')} />
              ...
              <div className="adv-filter-box clickable" onClick={() => toggleDropdown('advBathrooms')}>
                <div className="adv-label">{t('bathrooms')}</div>
                <div className="adv-dropdown">
                  <span>{advBathrooms === 'Any' ? t('any') : advBathrooms}</span> 
              ...
              <div className="adv-filter-box clickable" onClick={() => toggleDropdown('energyRating')}>
                <div className="adv-label">{t('energyRating')}</div>
                <div className="adv-dropdown">
                  <span>{energyRating === 'Any' ? t('any') : energyRating}</span> 
            ...
            <div className="adv-grid-bottom">
              <div className="adv-features">
                <div className="adv-label">{t('features')}</div>
                <div className="adv-checkboxes">
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="14" width="18" height="8" rx="2" ry="2"></rect><path d="M3 14h18M5 14v-4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v4"></path></svg> {t('filters.balcony')}</label>
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 20A7 7 0 0 1 14 6h7v7a7 7 0 0 1-10 7z"></path></svg> {t('filters.garden')}</label>
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 16H9m10 0h3v-3.15a1 1 0 0 0-.84-.99L16 11l-2.7-3.6a2 2 0 0 0-1.6-.8H9.3a2 2 0 0 0-1.6.8L5 11l-5.16.86a1 1 0 0 0-.84.99V16h3m10 0a2 2 0 1 0 4 0 2 2 0 0 0-4 0zM5 16a2 2 0 1 0 4 0 2 2 0 0 0-4 0z"></path></svg> {t('filters.garage')}</label>
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 22h20M12 2v20M6 10c0-4 3-8 6-8s6 4 6 8"></path></svg> {t('filters.terrace')}</label>
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><polyline points="12 6 12 18"></polyline><polyline points="9 9 12 6 15 9"></polyline><polyline points="9 15 12 18 15 15"></polyline></svg> {t('filters.elevator')}</label>
                  <label><input type="checkbox"/> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"></path></svg> {t('filters.fireplace')}</label>
                </div>
              </div>

              <div className="adv-filter-box clickable" style={{ maxWidth: '250px' }} onClick={() => toggleDropdown('availability')}>
                <div className="adv-label">{t('availability')}</div>
                <div className="adv-dropdown">
                  <span>{availability === 'Any' ? t('any') : availability}</span> 
            ...
            <div className="adv-footer">
              ...
              <div className="adv-results">{t('found')}</div>
              <button className="adv-submit">{t('show')} &rarr;</button>
            </div>
