...
export default function PropertyCard({ imageSrc, type, price, location, specs, slug, className = "" }: PropertyCardProps) {
  return (
    <Link href={`/properties/${slug}` as any} className={`property-card ${className}`}>
