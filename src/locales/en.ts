export const en = {
  ...
  explore: {
    ...
    headline: 'Selected',
    headlineSerif: 'properties.',
    subhead: 'Discover a curated collection of exceptional homes tailored to your lifestyle. Every property is hand-selected for its architectural merit and premium location.',
    btn: 'VIEW ALL PROPERTIES',
    filters: {
      all: 'All Properties',
      villas: 'Villas',
      penthouses: 'Penthouses',
      historic: 'Historic Estates',
      apartments: 'Apartments',
      waterfront: 'Waterfront',
      offMarket: 'Off-Market',
    },
    noProps: 'No properties found in this category currently.'
  },
  why: {
    tag: 'WHY BOSSERT',
    headline: 'The standard is',
    headlineSerif: 'absolute.',
  ...
  cta: {
    ...
    subhead: 'Whether you are exploring a property, have a project in mind, or wish to discuss an off-market opportunity, we offer absolute discretion.',
    namePlaceholder: 'Your Name',
    emailPlaceholder: 'Your Email',
    msgPlaceholder: 'How can we assist you?',
    btnIdle: 'SUBMIT INQUIRY',
    btnSending: 'SENDING...',
    btnSent: 'MESSAGE SENT',
    success: 'Thank you. We will be in touch shortly.'
  },
  footer: {
    updates: 'Get listing updates',
    ...
    intro: {
      ...
      challenges: [
        ...
        },
        {
          ...
          desc: 'Contracts, disclosures, and regulatory requirements handled with precision, so nothing falls through the cracks and every transaction stands on solid ground.'
        }
      ],
      highlights: [
  ...
  leadForms: {
    ...
    searchProfile: {
      eyebrow: 'Individual. Discreet. Personal.',
      title: 'Create your exclusive search profile',
      subhead: 'Tell us what you are looking for — we will contact you personally as soon as a matching property becomes available.',
      sectionPersonal: 'Personal information',
      sectionCriteria: 'Your search criteria',
      salutation: 'Salutation',
      firstName: 'First name',
      lastName: 'Last name',
      email: 'Email',
      phone: 'Phone number',
      marketingType: 'Transaction type',
      ...
      roomsTo: 'Rooms to',
      specialWishes: 'Your specific requirements',
      specialWishesPlaceholder: 'Individual preferences — regarding location, fit-out or architecture — are welcome here.',
      submit: 'Create search profile and get started',
      successTitle: 'Your search profile is set up',
      successBody: 'Thank you. We will be in touch as soon as we have a property that matches your criteria.',
    },
    // Eigentümer — property lead wizard (/list-property)
    propertyLead: {
      picker: {
        eyebrow: 'For owners',
        title: 'What type of property is this about?',
        subhead: 'Select the category — we will personally guide you through everything else, promptly.',
        house: 'Single-family or multi-family home',
        apartment: 'Apartment',
        commercial: 'Commercial',
      },
      wizard: {
        ...
        subhead: 'So that we can advise you properly, we need a few details.',
        stepOf: 'Step {current} of {total}',
        back: 'Back',
        next: 'Continue',
        submit: 'Request a no-obligation consultation',
        step1: 'Property details',
        step2: 'Fit-out & condition',
        step3: 'Your plans',
        step4: 'Contact details',
      },
      fields: {
        propertyTypeHouse: 'House type',
        propertyTypeApartment: 'Apartment type',
        propertyTypeCommercial: 'Type of commercial property',
        buildYear: 'Year built (approx.)',
        livingArea: 'Living area (approx., m²)',
        usableArea: 'Usable area (approx., m²)',
        totalArea: 'Total area (approx., m²)',
        rooms: 'Number of rooms',
        bathrooms: 'Number of bathrooms',
        rentalStatus: 'Is the property currently rented?',
        condition: 'Condition',
        features: 'Which features does your property have?',
        parkingSpaces: 'Number of parking spaces',
        intent: 'What are you planning?',
        intentSell: 'Sell',
        intentRent: 'Rent out',
        timeframe: 'Timeframe',
        location: 'Location',
    ...
    common: {
      ...
      marketingTypes: { kauf: 'Buy', miete: 'Rent', pacht: 'Lease', erbpacht: 'Ground lease' },
      categories: { wohnung: 'Apartment', haus: 'House', grundstueck: 'Land', gewerbe: 'Commercial' },
      houseTypes: ['Detached house', 'Semi-detached house', 'Terraced house', 'End-terrace house', 'Multi-family house', 'Villa', 'Bungalow'],
      apartmentTypes: ['Apartment', 'Ground-floor apartment', 'Attic apartment', 'Maisonette', 'Penthouse', 'Loft', 'Souterrain apartment'],
      commercialTypes: ['Office / practice', 'Retail', 'Warehouse / logistics', 'Hospitality', 'Hotel'],
      conditions: ['First occupancy', 'As new', 'Fully renovated', 'Modernised', 'Well maintained', 'In need of renovation'],
      timeframes: ['Not decided yet', 'At a later point', 'Within the next few months', 'As soon as possible'],
      featureList: ['Elevator', 'Balcony', 'Garage', 'Garden', 'Fitted kitchen', 'Terrace', 'Pool'],
      consent: 'I have read the Terms & Conditions and the Privacy Policy and consent to the processing of my data for the purpose of handling my inquiry.',
  ...
  admin: {
    ...
    references: {
      eyebrow: 'Content',
      title: 'References',
      lead: 'Successfully brokered properties shown on the References page. Each entry has an English and a German version.',
      newBtn: '+ New reference',
      colTitle: 'Title',
      colLocation: 'Location',
      colType: 'Type',
      colStatus: 'Status',
      empty: 'No references yet. Create your first one.',
      resultCount_one: 'reference',
      resultCount_other: 'references',
      form: {
        slug: 'Slug (URL)',
        titleEn: 'Title (EN)',
        titleDe: 'Title (DE)',
        ...
        descriptionDe: 'Short description (DE)',
        fullDescEn: 'Full description (EN)',
        fullDescDe: 'Full description (DE)',
        stats: 'Stats (featured only)',
        statLabel: 'Label',
        statValue: 'Value',
        addStat: '+ Add stat',
        features: 'Features',
        featureEn: 'Feature (EN)',
        featureDe: 'Feature (DE)',
    ...
    testimonials: {
      eyebrow: 'Content',
      title: 'Testimonials',
      lead: 'Client quotes shown in the homepage testimonial carousel.',
      newBtn: '+ New testimonial',
      colAuthor: 'Author',
      colLocation: 'Location',
      colStatus: 'Status',
      empty: 'No testimonials yet. Create your first one.',
      form: {
        quoteEn: 'Quote (EN)',
        quoteDe: 'Quote (DE)',
        author: 'Author',
    ...
    teamMembers: {
      eyebrow: 'Content',
      title: 'Team',
      lead: 'Leadership profiles shown on the About page.',
      newBtn: '+ New team member',
      colName: 'Name',
      colTitle: 'Title',
      colStatus: 'Status',
    ...
    faqs: {
      eyebrow: 'Content',
      title: 'FAQs',
      lead: 'Questions and answers shown on the Contact page.',
      newBtn: '+ New FAQ',
      colQuestion: 'Question',
      colStatus: 'Status',
      empty: 'No FAQs yet. Create your first one.',
      form: {
    ...
    newsletter: {
      eyebrow: 'Content',
      title: 'Newsletter',
      lead: 'Everyone who has subscribed via the site footer.',
      colEmail: 'Email',
      colStatus: 'Status',
      colSubscribedAt: 'Subscribed',
      empty: 'No subscribers yet.',
      exportBtn: 'Export CSV',
      resultCount_one: 'subscriber',
      resultCount_other: 'subscribers',
    },
    siteSettings: {
      eyebrow: 'Content',
      title: 'Site Settings',
      lead: 'Operational contact details shown across the public site (footer, contact page, CTA sections).',
      save: 'Save settings',
