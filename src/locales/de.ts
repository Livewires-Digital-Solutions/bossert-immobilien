export const de = {
  ...
  heroCarousel: {
    ...
    slides: [
      ...
      },
      {
        ...
        desc: 'Mit präzisen Markteinblicken und der passenden Strategie erreicht Ihre Immobilie die richtigen Käufer zum richtigen Preis.',
        href: '/services',
      },
      {
        category: 'Kauf',
        ...
        desc: 'Ihre neue Immobilie wartet auf Sie. Wir begleiten Sie bei jedem Schritt — von der Suche bis zum sicheren Erwerb.',
        href: '/properties',
      },
    ],
  },
  ...
  footer: {
    ...
    linkProperties: 'Immobilienangebote',
    linkServices: 'Dienstleistungen',
    linkCancelContract: 'Vertrag widerrufen',
