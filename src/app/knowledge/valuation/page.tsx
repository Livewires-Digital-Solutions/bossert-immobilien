...
const CATEGORY: KnowledgeCategory = "Valuation";
const cat = KNOWLEDGE_CATEGORIES.find((c) => c.label === CATEGORY)!;

export const metadata: Metadata = {
  title: `${CATEGORY} – Knowledge – Bossert Immobilien`,
  description: cat.description,
};

export default function ValuationKnowledgePage() {
    ...
    <div className="bg-[var(--background)] min-h-screen">
      ...
      <section className="py-24 px-6 md:px-10 bg-[var(--cream)]">
        <div className="max-w-[1400px] mx-auto">
          <SectionHeader eyebrow={CATEGORY} title={`${CATEGORY} Guides & Articles`} description={cat.description} className="mb-16" />
          {articles.length === 0 ? (
