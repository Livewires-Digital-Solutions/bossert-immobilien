        ...
        <div className={`inner-page-container ${styles.topGrid}`} style={{ display: 'flex', flexWrap: 'wrap' }}>
          ...
          <div className={`reveal-base reveal-up ${topVisible ? 'is-revealed' : ''}`} style={{ flex: '1 1 25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className={styles.introEyebrow}>
              <span className={styles.introEyebrowLine} />
              <span className={styles.introEyebrowText}>{contact.intro.eyebrow}</span>
              <span className={styles.introEyebrowLine} />
            </div>

            <h2 className={styles.introHeading}>
              {contact.intro.titleLine1}
              <br />
              {contact.intro.titleLine2}<span className="italic-serif">{contact.intro.titleLine2Accent}</span>
            </h2>

            <p className={styles.introDescription}>{contact.intro.description}</p>
          ...
          <div className={`reveal-base reveal-up delay-200 ${topVisible ? 'is-revealed' : ''}`} style={{ flex: '1 1 31.25rem' }}>
            <div className={styles.formCard} style={{ backgroundColor: 'var(--white)', boxShadow: '0 4px 20px rgba(4,36,51,0.03)' }}>
              {success ? (
                ...
                <>
                  <div className={styles.formCardHeader}>
                    <div>
                      <p className={styles.formCardEyebrow}>{contact.formCard.eyebrow}</p>
                      <h3 className={styles.formCardTitle}>{contact.formCard.title}</h3>
                    </div>
                    <p className={styles.formCardHint}>{contact.formCard.hint}</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} noValidate className={styles.formGrid}>
                    ...
                    <div className={styles.selectWrapper}>
                      <select
                        className={`${styles.boxField} ${styles.selectField}`}
                    ...
                    <textarea
                      ...
                      maxLength={4000}
                      rows={4}
                      className={`${styles.boxField} ${styles.boxTextarea}`}
                      value={form.message}
                    ...
                    <div className={styles.consentRow}>
                      ...
                      />
                      <label htmlFor="privacy" className={styles.consentLabel}>{contact.form.privacy}</label>
                    </div>
