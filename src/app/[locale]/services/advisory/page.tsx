    ...
    <div className="bg-[var(--background)] min-h-screen">
      ...
      <section className="py-20 px-6 md:px-10 bg-[var(--navy)]">
        <div className="max-w-[700px] mx-auto text-center">
          <h2 className="font-display text-4xl text-[var(--cream)] mb-6">Strategic counsel, tailored to you.</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/services" className="cta-btn !bg-transparent !text-[var(--cream)] !border !border-[var(--cream)]/20" id="advisory-services">
              All Services
